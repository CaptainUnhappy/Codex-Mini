...
- 版本：Codex Mini v4.1.4
- 安装包：[直接下载 Codex Mini v4.1.4.dmg](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v4.1.4/Codex.Mini.v4.1.4.dmg)
- Release 页面：[codex-mini-v4.1.4](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v4.1.4)
- 安装方式：打开 DMG，把 `Codex Mini.app` 拖进 `Applications`

### 最新版 V4.1.4

- 大幅优化发送速度：本地发送链路从约 0.5 秒降到约 0.1 秒
- 云端 / 外网入口发送速度明显提升：从约 2～3 秒降到约 0.3 秒
- 新增更快的当前线程发送路径，减少发送前重复同步和等待
- 优化本地发送预检和外网中转发送链路，手机点击发送后的响应更跟手
- 修复手机端部分 Markdown 四级标题显示不够清楚的问题
- 微调守护模式居中和多屏显示位置，视觉更稳定

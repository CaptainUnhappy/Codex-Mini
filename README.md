...
- 版本：Codex Mini v4.1.1
- 安装包：[直接下载 Codex Mini v4.1.1.dmg](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v4.1.1/Codex.Mini.v4.1.1.dmg)
- Release 页面：[codex-mini-v4.1.1](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v4.1.1)
...
- 优化手机端附件查看方式：图片和文件预览改为页内弹层，不再跳到独立页面，减少 Safari / 主屏幕 Web App 顶部底部工具栏干扰
- 新增附件查看返回体验，文件可在当前聊天页查看信息并继续下载
- 优化电脑版控制面板入口：网站入口改为二次选择面板，可扫码、复制链接、打开网页或关闭
- 新增并优化守护模式：支持立即启动和空闲自动启动，全屏黑色遮罩默认保持亮屏，展示当前工作状态并增加更柔和的呼吸动效
- 修复守护模式点击后可能崩溃的问题，并增加启动后 3 秒忽略鼠标移动，避免刚打开就误退出
- 修复 App 重开或服务恢复时 Pro 状态短暂显示未激活的问题
- 继续优化全 CDP 受控 Codex 在后台/最小化场景下的稳定性

### V4.1.0 更新内容

- 新增附件发送：手机端可以直接选择并发送图片、视频和其他文件到当前 Codex 线程
- 新增附件接收与展示：Codex 返回的附件可以在手机页面里预览或下载
- 附件大小限制更清晰：图片最大 20MB，视频和其他文件最大 100MB
- 新增设置按钮和设置面板，常用显示、外观、签名、顶部胶囊顺序等选项集中管理
- 优化手机端文件卡片、附件托盘、发送状态和错误提示，发送前更容易看清当前附件
- 继续优化全 CDP 发送链路和后台静默运行体验，整体响应更快、更稳定
...
1. 在 Releases 页面下载带版本号的 `Codex.Mini.v4.1.1.dmg`

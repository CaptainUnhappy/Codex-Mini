...
- 版本：Codex Mini v4.1.2
- 安装包：[直接下载 Codex Mini v4.1.2.dmg](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v4.1.2/Codex.Mini.v4.1.2.dmg)
- Release 页面：[codex-mini-v4.1.2](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v4.1.2)
- 安装方式：打开 DMG，把 `Codex Mini.app` 拖进 `Applications`

### 最新版 V4.1.2

- 修复软件内“检查更新”下载后安装失败的问题，更新流程更稳定
- AI 生图结果现在会在手机端显示为图片附件，可直接查看和下载
- 优化附件缓存清理，减少旧上传文件长期占用空间
- 保持亮屏状态更稳定，服务或网络短暂中断后会自动恢复用户原本的开启状态
- 守护模式继续优化：工作卡片显示更准确，光效更稳定，长时间运行更顺滑
- 线程菜单新增 Codex 项目排序方式，查找项目线程更方便
- 继续优化受控 Codex 启动提醒和后台运行稳定性

...
- 版本：Codex Mini v4.2.1
- 安装包：[直接下载 Codex Mini v4.2.1.dmg](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v4.2.1/Codex.Mini.v4.2.1.dmg)
- Release 页面：[codex-mini-v4.2.1](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v4.2.1)
